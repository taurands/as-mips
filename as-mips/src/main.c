...
int main(int argc, char *argv[])
{
    ...
    do { /* Do While pour permettre de sortir proprement en cas de problème d'allocation mémoire */
    	if ((erreur = creer_liste (&listeLexemes_p, (fonctionDestructeur *)detruit_lexeme)))
    		break;
    	if ((erreur = creer_liste (&listeText_p, NULL)))
    		break;
    	if ((erreur = creer_liste (&listeData_p, NULL)))
    		break;
    	if ((erreur = creer_liste (&listeBss_p, NULL)))
    		break;
	...
	detruire_liste (&listeText_p);
    detruire_liste (&listeData_p);
    detruire_liste (&listeBss_p);
	detruire_liste (&listeLexemes_p);
